...
public class Main {
    ...
    public static Jugador crearJugador(ArrayList<Equipo> equipos) {
        ...
        if (noHayEquipos) {
            ...
            int edadDelJugador = sc.nextInt();
            Jugador jugador = new Jugador(nombre, edadDelJugador, equipoElegido, numeroCamiseta);
            return jugador;
        }
    }
    ...
    public static void eliminarEquipo(ArrayList<Equipo> equipos, ArrayList<Jugador> jugadores) {
        ...
        System.out.println("Equipo eliminado y jugador eliminado!");
    }
